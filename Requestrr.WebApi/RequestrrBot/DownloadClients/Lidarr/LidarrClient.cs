...
namespace Requestrr.WebApi.RequestrrBot.DownloadClients.Lidarr
{
    public class LidarrClient : IMusicSearcher, IMusicRequester
    {
        ...
        public Task<IReadOnlyList<MusicAlbum>> SearchAlbumsForArtistIdAsync(MusicRequest request, string artistId)
        {
            return CreateInstance<IMusicSearcher>().SearchAlbumsForArtistIdAsync(request, artistId);
        }

        public Task<MusicAlbum> SearchAlbumForIdAsync(MusicRequest request, string albumId)
        {
            return CreateInstance<IMusicSearcher>().SearchAlbumForIdAsync(request, albumId);
        }

        public Task<IReadOnlyList<MusicAlbum>> SearchAlbumsByTermAsync(MusicRequest request, string term)
        {
            return CreateInstance<IMusicSearcher>().SearchAlbumsByTermAsync(request, term);
        }
