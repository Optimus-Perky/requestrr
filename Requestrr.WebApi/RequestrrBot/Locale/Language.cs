...
namespace Requestrr.WebApi.RequestrrBot.Locale
{
    public static class LanguageTokens
    {
        ...
        public static string MusicAlbumTitle = "[MusicAlbumTitle]";
    ...
    public class Language
    {
        ...
        [JsonProperty("Discord.Command.Music.RequestWholeArtist.Button")]
        public string DiscordCommandMusicRequestWholeArtistButton { get; set; }

        [JsonProperty("Discord.Command.Music.RequestSpecificAlbum.Button")]
        public string DiscordCommandMusicRequestSpecificAlbumButton { get; set; }

        [JsonProperty("Discord.Command.Music.VariousArtists.ChoicePrompt")]
        public string DiscordCommandMusicVariousArtistsChoicePrompt { get; set; }
        ...
        [JsonProperty("Discord.Command.Music.Album.NotFound")]
        public string DiscordCommandMusicAlbumNotFound { get; set; }
        ...
        [JsonProperty("Discord.Command.Music.Album.SearchModal.Title")]
        public string DiscordCommandMusicAlbumSearchModalTitle { get; set; }

        [JsonProperty("Discord.Command.Music.Album.SearchModal.Label")]
        public string DiscordCommandMusicAlbumSearchModalLabel { get; set; }

        [JsonProperty("Discord.Command.Music.Album.SearchModal.Placeholder")]
        public string DiscordCommandMusicAlbumSearchModalPlaceholder { get; set; }
    }
}
