...
namespace Requestrr.WebApi.RequestrrBot.Locale
{
    public static class LanguageExtensions
    {
        ...
        public static string ReplaceTokens(this string text, MusicAlbum musicAlbum, Dictionary<string, string> additionalTokenReplacements = null)
        {
            Dictionary<string, string> musicReplacementTokens = new Dictionary<string, string>
            {
                { LanguageTokens.MusicAlbumTitle, musicAlbum.Title },
                { LanguageTokens.MusicArtistName, musicAlbum.ArtistName }
            };
